...
Citizen.CreateThread(function()
	...
	AddTextEntry('POLICE_SLICK2','Slicktop')
	AddTextEntry('0xFECF3A9D','ALPR Cameras(PD)')
	AddTextEntry('POLICE_ALPR2','ALPR Cameras & Aero Package')
	...
	AddTextEntry('POLICE_LIV17','BCSO Ghost (HC Only)')
	AddTextEntry('POLICE_LIV18','LSPD Ghost (HC Only)')
	AddTextEntry('POLICE_C0_DEP','0 - Patrol')
	AddTextEntry('POLICE_C1_DEP','1 - SCU')
	AddTextEntry('POLICE_C2_DEP','2 - HVTU')
	AddTextEntry('POLICE_C3_DEP','3 - Park Rangers')
	AddTextEntry('POLICE_C4_DEP','4 - S.W.A.T.')
	AddTextEntry('POLICE_C5_DEP','5 - SRU')
	AddTextEntry('POLICE_C6_DEP','6 - BTF')
	AddTextEntry('POLICE_C7_DEP','7')
	AddTextEntry('POLICE_C8_DEP','8')
	AddTextEntry('POLICE_C9_DEP','9')
	AddTextEntry('POLICE_C0_RANK','0 - Cadet')
	AddTextEntry('POLICE_C1_RANK','1 - Solo Cadet')
	AddTextEntry('POLICE_C2_RANK','2 - Officer / Deputy')
	AddTextEntry('POLICE_C3_RANK','3 - Sr Officer / Deputy')
	AddTextEntry('POLICE_C4_RANK','4 - Corporal')
	AddTextEntry('POLICE_C5_RANK','5 - Sergeant')
	AddTextEntry('POLICE_C6_RANK','6 - Lieutenant')
	AddTextEntry('POLICE_C7_RANK','7 - Captain')
	AddTextEntry('POLICE_C8_RANK','8 - Ass. Chief / Undersheriff ')
	AddTextEntry('POLICE_C9_RANK','9 - Chief of Police / Sheriff')
	...
	--Charger
	AddTextEntry("POLICECHAR_BBAR_1", "Widebar")
	AddTextEntry("POLICECHAR_BBAR_2", "Widebar for Hellcat Conversion (SRU Leaders)")
	AddTextEntry("POLICE_CHAR_CONVER", "Hellcat Conversion (SRU Leaders)")
	AddTextEntry("POLICECHAR_LIV_SASP2", "SASP Snow Leopard HP")
	AddTextEntry("POLICE_SLICK3", "Slicktop")
	AddTextEntry("POLICE_SLICK4", "Performance Package")
	AddTextEntry("POLICECHAR_SPL0", "SRT Spoiler (Cpt+)")
	AddTextEntry("POLICECHAR_SPL1", "Hellcat Spoiler (SRU Leaders)")
	--Explorer
	AddTextEntry("POLICEEXP_ANT1", "LSPD City Range")
	AddTextEntry("POLICEEXP_ANT2", "State & County Range")
	AddTextEntry("POLICEEXP_BBAR_1", "Widebar")
	-- Generic Spoiler
